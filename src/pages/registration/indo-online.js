...
function IndonesiaOnline() {
  ...
  const scriptURL =
    "https://script.google.com/macros/s/AKfycbxb8oFQSjBHjvK-_t4DB7bll0pt-zC6IfGuq2AwnHqm8QJevfzhk_9Bq5kHAMrDjQgB/exec";
      ...
      <section className="registration-section">
        <div className="container">
          <div className="content">
            ...
            <br />
            <h4>
              HELLO GYIIF 2026 INDONESIAN CITIZEN, Please consider the following
