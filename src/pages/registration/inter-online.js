...
export default function InternationalOnline() {
  ...
  const handleCategoryChange = (e) => {
    ...
    switch (value) {
      case "Global Youth Invention and Innovation Fair - Online Competition":
        setCategoryPrice("$105 USD");
        break;
      case "Global Youth Invention and Innovation Fair - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)":
        setCategoryPrice("$225 USD");
        break;
      case "Global Youth Invention and Innovation Fair - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)":
  ...
  const scriptURL =
    "https://script.google.com/macros/s/AKfycbxu1hr4eF26j9VY1vK5lGwzy1P2TbzRgbfrFG6TPlOnC0oEgZjLzInTf3x-uXt4x1O6/exec";
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="Global Youth Invention and Innovation Fair - Online Competition">
                      Online Competition
                    </option>
                    <option value="Global Youth Invention and Innovation Fair - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)">
                      Online Competition + Certificate and Medal (SOUTH EAST
                      ASIA)
                    </option>
                    <option value="Global Youth Invention and Innovation Fair - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)">
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="INFORMATION_RESOURCES" className="form-label">
                    GYIIF 2026 Competition Information Resources
                  </label>
                  <select
                    type="text"
